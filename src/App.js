  ...
  render() {
    ...
    const person = {
      ...
      projects: [
        ...
        {jobTitle: 'Confidential Project', company:'Encore Theme Technologies', startDate: 'November 2018', endDate: 'September 2019', jobDescription: 'Confidential project done using Hyperledger Blockchain framework'},
